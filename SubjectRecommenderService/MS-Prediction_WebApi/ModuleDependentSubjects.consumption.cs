...
namespace ModuleDependentSubjectsPrediction_CA
{
    ...
    {
        /// <summary>
        /// model input class for ModuleDependentSubjects.
        /// </summary>
        ...
        public class ModelInput
        {
            ...
            [ColumnName(@"MODULE_DEPENDENT_SUB_PAIR")]
            public float MODULE_DEPENDENT_SUB_PAIR { get; set; }
        ...
        /// <summary>
        /// model output class for ModuleDependentSubjects.
        /// </summary>
        ...
        private static string MLNetModelPath = Path.GetFullPath("ModuleDependentSubjects.zip");
