...
{
    /// <summary>
    /// model input class for Subject2Prediction.
    /// </summary>
    ...
    public class ModelInput
    {
        ...
        [ColumnName(@"CHOOSEN_SUBJECT_ID_2_BLOCK_A")]
        public float CHOOSEN_SUBJECT_ID_2_BLOCK_A { get; set; }
    ...
    /// <summary>
    /// model output class for Subject2Prediction.
    /// </summary>
    ...
    private static string MLNetModelPath = Path.GetFullPath("Subject2Prediction.zip");
