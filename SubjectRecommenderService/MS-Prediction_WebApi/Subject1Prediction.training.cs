...
namespace Subject1Prediction_WebApi
{
    public partial class Subject1Prediction
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(@"GENDER", @"GENDER")      
                                    ...
                                    .Append(mlContext.Transforms.Conversion.MapValueToKey(@"CHOOSEN_SUBJECT_ID_1_BLOCK_A", @"CHOOSEN_SUBJECT_ID_1_BLOCK_A"))      
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastForest(new FastForestBinaryTrainer.Options(){NumberOfTrees=4,FeatureFraction=0.269416731082934F,LabelColumnName=@"CHOOSEN_SUBJECT_ID_1_BLOCK_A",FeatureColumnName=@"Features"}), labelColumnName: @"CHOOSEN_SUBJECT_ID_1_BLOCK_A"))      
