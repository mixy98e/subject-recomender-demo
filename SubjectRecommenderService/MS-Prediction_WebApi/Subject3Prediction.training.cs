...
public partial class Subject3Prediction
{
    ...
    public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
    {
        ...
        var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(@"GENDER", @"GENDER")
                                ...
                                .Append(mlContext.Transforms.Conversion.MapValueToKey(@"CHOOSEN_SUBJECT_ID_3_BLOCK_A", @"CHOOSEN_SUBJECT_ID_3_BLOCK_A"))
                                .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator: mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options() { NumberOfLeaves = 10, MinimumExampleCountPerLeaf = 24, NumberOfTrees = 4, MaximumBinCountPerFeature = 93, LearningRate = 0.209987945745687F, FeatureFraction = 0.996313587998529F, LabelColumnName = @"CHOOSEN_SUBJECT_ID_3_BLOCK_A", FeatureColumnName = @"Features" }), labelColumnName: @"CHOOSEN_SUBJECT_ID_3_BLOCK_A"))
