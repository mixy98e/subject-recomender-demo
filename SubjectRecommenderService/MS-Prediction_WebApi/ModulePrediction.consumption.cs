...
{
    /// <summary>
    /// model input class for ModulePrediction.
    /// </summary>
    ...
    /// <summary>
    /// model output class for ModulePrediction.
    /// </summary>
    ...
    private static string MLNetModelPath = Path.GetFullPath("ModulePrediction.zip");
