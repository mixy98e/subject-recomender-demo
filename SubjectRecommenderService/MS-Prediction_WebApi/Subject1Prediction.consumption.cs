...
{
    /// <summary>
    /// model input class for Subject1Prediction.
    /// </summary>
    ...
    public class ModelInput
    {
        ...
        [ColumnName(@"CHOOSEN_SUBJECT_ID_1_BLOCK_A")]
        public float CHOOSEN_SUBJECT_ID_1_BLOCK_A { get; set; }
    ...
    /// <summary>
    /// model output class for Subject1Prediction.
    /// </summary>
    ...
    private static string MLNetModelPath = Path.GetFullPath("Subject1Prediction.zip");
